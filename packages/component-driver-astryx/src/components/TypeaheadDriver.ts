...
export class TypeaheadDriver extends AstryxComboboxDriver {
  ...
  /** Whether a search is in flight — Astryx shows a spinner (`role="status"`) in the input. */
  async isLoading(): Promise<boolean> {
    return this.interactor.exists(locatorUtil.append(this.locator, byCssSelector('[role="status"]')));
  }
