import { byTagName, ComponentDriver, locatorUtil, Optional, PartLocator, timingUtil } from '@atomic-testing/core';
...
export class CollapsibleDriver extends ComponentDriver<{}> {
  private get triggerLocator(): PartLocator {
    return locatorUtil.append(this.locator, byTagName('button'));
  }
