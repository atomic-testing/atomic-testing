...
export class MultiSelectorDriver extends AstryxComboboxDriver {
  ...
  /** The labels of the currently selected options (`aria-selected="true"`), excluding "select all". Opens the popup. */
  ...
  /** The number of selected options. Opens the popup. */
  async getSelectedCount(): Promise<number> {
    return (await this.getSelectedLabels()).length;
  }
