# @atomic-testing/component-driver-angular-material-v20
...
```bash
npm install @atomic-testing/core @atomic-testing/angular-20 \
  @atomic-testing/component-driver-html @atomic-testing/component-driver-angular-material-v20 --save-dev
```
