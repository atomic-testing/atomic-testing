...
```bash
npm install @atomic-testing/core @atomic-testing/angular-22 \
  @atomic-testing/component-driver-html @atomic-testing/component-driver-angular-material-v22 --save-dev
```
...
2. Define a `ScenePart` describing the count display and button using the Material driver:
   ...
   import { ButtonDriver } from '@atomic-testing/component-driver-angular-material-v22';
