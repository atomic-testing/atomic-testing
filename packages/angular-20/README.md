...
[Angular 20](https://angular.dev). It maps standalone Angular components to
the core scene part APIs.

This package is a thin re-export of `@atomic-testing/angular-core` that pins
the Angular 20 peer range — the implementation (interactor, settling, and
...
```bash
npm install --save-dev @atomic-testing/angular-20 @atomic-testing/component-driver-html
```
