...
| `WaitForOption`, `WaitForCondition`, `defaultWaitForOption`, `defaultSettleProbeIntervals`, `WaitUntilOption`                           | types/const             | [WaitForOption.ts](../../packages/core/src/drivers/WaitForOption.ts), [timingUtil.ts](../../packages/core/src/utils/timingUtil.ts#L14) |
