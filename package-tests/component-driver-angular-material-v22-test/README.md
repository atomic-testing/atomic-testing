# @atomic-testing/component-driver-angular-material-v22-test

Examples and tests for `@atomic-testing/component-driver-angular-material-v22`,
...
config auto-starts/stops the dev server (port 5222).
...
# (stale-dist trap)
pnpm --filter "@atomic-testing/component-driver-angular-material-v22-test..." build
...
preinstalled in the dev container — see `package-tests/angular-22-test`'s
