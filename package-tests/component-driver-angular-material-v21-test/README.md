# @atomic-testing/component-driver-angular-material-v21-test

Examples and tests for `@atomic-testing/component-driver-angular-material-v21`,
...
config auto-starts/stops the dev server (port 5221).
...
# (stale-dist trap)
pnpm --filter "@atomic-testing/component-driver-angular-material-v21-test..." build
