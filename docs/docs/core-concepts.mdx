...
:::note
`ContainerDriver<ContentT, T>` and its `content` option were the earlier form of this and are **deprecated** — see [ADR-019](https://github.com/atomic-testing/atomic-testing/blob/main/agent-docs/adr/019-call-time-scope-supersedes-container-content.md). They still work, and are scheduled for removal in 2.0.
:::
