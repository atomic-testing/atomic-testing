...
<div className='card-container' style={{ display: 'flex', gap: '1rem', marginTop: '2rem', flexWrap: 'wrap' }}>
  <div className='card'>
    <div className='card__header'>
      <h3>🤖 Let Your Agent Write the Tests</h3>
    </div>
    <div className='card__body'>
      <p>The scaffolder just installed four agent skills — say "write tests for <em>MyComponent</em>" and review the plan.</p>
