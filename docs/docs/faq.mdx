...
Below are some commonly asked questions about using **Atomic Testing**. They are organized by audience so you can jump to the topics that matter most to you.

## For software developers

### How do I start using Atomic Testing?

Install the packages for your preferred test environment and UI library. Then define *SceneParts* for the components you want to interact with and create a **Test Engine** instance. The [Getting Started Tutorial](./getting-started-tutorial.mdx) walks through these steps.
